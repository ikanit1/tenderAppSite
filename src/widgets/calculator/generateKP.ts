...
export function buildKPDocument(
            ...
            children: [
              ...
              new TableCell({
                ...
                children: [
                  ...
                  new Paragraph({ alignment: AlignmentType.RIGHT, children: [new TextRun({ text: 'grgroup.kz', font: FONT, size: SIZE_11, color: '444444' })] }),
  ...
  children.push(p('ИТОГО: ' + formatKzt(result.grandTotal), { bold: true, size: SIZE_12, spacingAfter: 200 }));
