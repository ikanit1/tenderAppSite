export const siteConfig = {
  name: 'GR Group',
  defaultDescription: 'Монтаж систем безопасности, видеонаблюдения, электромонтажные работы в Казахстане',
...
export const pageSEOConfig: Record<string, PageSEO> = {
  home: {
    title: 'GR Group — Системы безопасности и электромонтаж в Казахстане',
    description: 'Монтаж систем видеонаблюдения, СКУД, пожарной сигнализации и электромонтажные работы. Работаем по всему Казахстану.',
    keywords: ['системы безопасности', 'видеонаблюдение', 'электромонтаж', 'СКУД', 'Казахстан'],
  },
  services: {
    title: 'Услуги — GR Group',
    description: 'Полный спектр услуг: видеонаблюдение, СКУД, пожарная сигнализация, электромонтаж, умный дом.',
    keywords: ['услуги', 'видеонаблюдение', 'электромонтаж', 'монтаж систем безопасности'],
  },
  calculator: {
  ...
  projects: {
    ...
    description: 'Реализованные проекты по монтажу систем безопасности и электромонтажу.',
