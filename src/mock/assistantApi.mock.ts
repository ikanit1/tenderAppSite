...
const KEYWORD_RESPONSES: Array<{ keywords: string[]; answer: string }> = [
  {
    ...
    answer:
      'Для расчёта стоимости пришлите площадь объекта и тип работ (слаботочные системы, видеонаблюдение, СКУД и т.д.). Можете воспользоваться калькулятором на сайте или оставить заявку — мы подготовим смету в течение 1–2 дней.',
  },
  {
    keywords: ['квартир', 'квартира', 'квартире'],
    answer:
      'Для квартир мы выполняем монтаж систем видеонаблюдения, контроля доступа, домофонии и умного дома. Оставьте заявку — подготовим точную смету под вашу планировку.',
  },
  {
    keywords: ['офис', 'офиса', 'коммерческ'],
    answer:
      'Для офисов и коммерческих помещений мы выполняем СКС, видеонаблюдение, контроль доступа, пожарную сигнализацию. Стоимость от 2000 ₸/м². Напишите площадь и пожелания — рассчитаем смету.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Привет! Я помогу с вопросами по системам безопасности и слаботочным системам. Напишите, что вас интересует: смета, сроки, виды работ или оставьте заявку на расчёт.',
  },
];
